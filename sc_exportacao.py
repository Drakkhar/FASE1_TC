...
import pandas as pd
import re
from models import Exportacao, SessionLocal

# Mapeamento dos tipos de exportação
TIPOS = {
...
URL = "http://vitibrasil.cnpuv.embrapa.br/index.php?subopcao={tipo}&ano={ano}&opcao=opt_06"

# Detecta o intervalo de anos disponível
url_base = "http://vitibrasil.cnpuv.embrapa.br/index.php?opcao=opt_06"
