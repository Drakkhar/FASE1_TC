...
import pandas as pd
import re
from models import Producao, SessionLocal, Base, engine
base_url = 'http://vitibrasil.cnpuv.embrapa.br/index.php?ano={}&opcao=opt_02'

# 1. Obter os anos disponíveis a partir da página inicial
initial_url = 'http://vitibrasil.cnpuv.embrapa.br/index.php?opcao=opt_02'
